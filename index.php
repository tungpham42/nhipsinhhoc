        ...
        <div class="container mx-auto px-0">
          <div class="row w-100 mx-auto py-5 px-0">
            ...
            <form class="dates mx-auto" id="date-input">
              <div class="date shadow-lg rounded" data-disable-interaction="true" data-step="12" data-intro="Chọn ngày sinh của bạn">
              ...
              <div class="date shadow-lg rounded" data-disable-interaction="true" data-step="13" data-intro="Chọn ngày sinh của đối tác">
      ...
      <div class="container-fluid comments px-0 border-top">
        <div class="container mx-auto px-0">
          <div class="row w-100 mx-auto p-5">
            <h2 class="mb-4 w-100" data-disable-interaction="true" data-step="15" data-intro="Màn giới thiệu kết thúc tại đây. Hãy để lại bình luận">Phần bình luận</h2>
<?php
